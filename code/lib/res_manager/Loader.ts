...
type LoadSceneArgs = {
    ...
    onProgress: (finish: number, total: number, item: cc.AssetManager.RequestItem) => void, 
    onComplete: (error: Error, assets: cc.SceneAsset) => void
}
...
function makeLoadArgs() {
    ...
    if (arguments[1].prototype instanceof cc.Asset) {
...
export class Loader implements ILoader {
     ...
     */
    public load<T extends cc.Asset>(paths: string, type: typeof cc.Asset, onProgress: (finish: number, total: number, item: cc.AssetManager.RequestItem) => void, onComplete: (error: Error, assets: T) => void): void;
    public load<T extends cc.Asset>(paths: string[], type: typeof cc.Asset, onProgress: (finish: number, total: number, item: cc.AssetManager.RequestItem) => void, onComplete: (error: Error, assets: Array<T>) => void): void;
    public load<T extends cc.Asset>(paths: string, onProgress: (finish: number, total: number, item: cc.AssetManager.RequestItem) => void, onComplete: (error: Error, assets: T) => void): void;
    public load<T extends cc.Asset>(paths: string[], onProgress: (finish: number, total: number, item: cc.AssetManager.RequestItem) => void, onComplete: (error: Error, assets: Array<T>) => void): void;
    public load<T extends cc.Asset>(paths: string, type: typeof cc.Asset, onComplete?: (error: Error, assets: T) => void): void;
    public load<T extends cc.Asset>(paths: string[], type: typeof cc.Asset, onComplete?: (error: Error, assets: Array<T>) => void): void;
    public load<T extends cc.Asset>(paths: string, onComplete?: (error: Error, assets: T) => void): void;
    public load<T extends cc.Asset>(paths: string[], onComplete?: (error: Error, assets: Array<T>) => void): void;	
    public load() {
     ...
     *@param onComplete 当加载所有资源或发生错误时调用的回调。
     */
    public loadDir<T extends cc.Asset>(dir: string, type: typeof cc.Asset, onProgress: (finish: number, total: number, item: cc.AssetManager.RequestItem) => void, onComplete: (error: Error, assets: Array<T>) => void): void;
    public loadDir<T extends cc.Asset>(dir: string, onProgress: (finish: number, total: number, item: cc.AssetManager.RequestItem) => void, onComplete: (error: Error, assets: Array<T>) => void): void;
    public loadDir<T extends cc.Asset>(dir: string, type: typeof cc.Asset, onComplete: (error: Error, assets: Array<T>) => void): void;
    public loadDir<T extends cc.Asset>(dir: string, type: typeof cc.Asset): void;
    public loadDir<T extends cc.Asset>(dir: string, onComplete: (error: Error, assets: Array<T>) => void): void;
    public loadDir<T extends cc.Asset>(dir: string): void;	
    public loadDir() {
        const args = makeLoadArgs.apply(null, arguments) as LoadArgs;
        if (args.type) {
            if (args.onProgress) {
     ...
     */
    public loadScene(sceneName: string, options: Record<string, any>, onProgress: (finish: number, total: number, item: cc.AssetManager.RequestItem) => void, onComplete: (error: Error, sceneAsset: cc.SceneAsset) => void): void;
    public loadScene(sceneName: string, onProgress: (finish: number, total: number, item: cc.AssetManager.RequestItem) => void, onComplete: (error: Error, sceneAsset: cc.SceneAsset) => void): void;
    public loadScene(sceneName: string, options: Record<string, any>, onComplete: (error: Error, sceneAsset: cc.SceneAsset) => void): void;
    public loadScene(sceneName: string, onComplete: (error: Error, sceneAsset: cc.SceneAsset) => void): void;
     ...
     * @returns 
     */
    public get<T extends cc.Asset> (path: string, type?: typeof cc.Asset): T {
     ...
     */
    public setSpriteFrame(target: cc.Node|cc.Sprite, path: string) {
    ...
    private setSource(path: string, target: cc.Node) {
    ...
    private loadComplete(err: Error, assets: cc.Asset | cc.Asset[], onComplete: (error: Error, assets: cc.Asset|cc.Asset[]) => void) {
        if (!err) {
