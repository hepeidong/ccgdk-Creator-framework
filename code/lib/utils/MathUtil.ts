...
export default class CCMathUtil {
     ...
     * @returns number
     */
     public static angle(a: number|cc.Vec3, b?: cc.Vec3): number {
        if (Utils.isNumber(a)) {
            return a as number * 180 / Math.PI;
        }
        else {
            return cc.Vec3.angle(a as cc.Vec3, b) * 180 / Math.PI;
        }
    }
     ...
     * @returns 
     */
    public static radian(a: number|cc.Vec3, b?: cc.Vec3): number {
        if (typeof a === 'number') {
