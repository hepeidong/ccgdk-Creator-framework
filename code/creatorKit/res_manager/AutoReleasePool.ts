...
export class AutoReleasePool extends EventListeners {
    ...
    private _animateMap: Map<string, AnimatT> = new Map();
    constructor(name: string = null) {
        super();
        this._name = name;
        DEBUG && (this._isClearing = false);
    ...
    public addAnimateData(key: string, animate: AnimatT): void {
    ...
    public getAnimateData(key: string): AnimatT {
...
export class PoolManager extends EventListeners {
    ...
    constructor() {
        super();
        ASSERT(!this._releasePoolStack, 'The "_releasePoolStack" is null!');
